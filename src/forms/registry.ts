import { contactRequest } from './definitions/contact-request'
import { serviceBooking } from './definitions/service-booking'
import { hatasa } from './definitions/hatasa'
import type { FormDef } from './types'

/** All forms available in the factory. Add a new form by appending here. */
export const forms: Array<FormDef> = [hatasa, contactRequest, serviceBooking]
